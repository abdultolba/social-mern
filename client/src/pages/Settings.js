                    ...
                    <div className="col-md-6">
                        <form onSubmit={this.handleNewDescription}>
                            <div className="form-group">
                                <textarea className="form-control" rows="4" maxLength="125" name="description" id="description" placeholder="Profile Description..." defaultValue={this.props.session.description}></textarea>
                            </div>
                            <div className="form-group">
                                <button className="btn btn-success btn-block">Edit Description</button>
                            </div>
                        </form>
                        <Files
                            ...
                            minFileSize={0}
                            clickable>
                            <button className="btn btn-primary btn-block">Upload Profile Photo</button>
                        </Files>
                    </div>
